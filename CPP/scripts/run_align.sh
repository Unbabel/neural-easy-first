...
model_prefix=exp_align_bidirectional_attention-${use_attention}_type-${attention_type}_startepoch-${warm_start_on_epoch}_eta-${learning_rate}_lambda-${regularization_constant}_costs-${cost_false_positives}-${cost_false_negatives}
